...
map.getView().fit([8529093.208170, 497265.714112, 9624894.445666, 1348370.221948], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Webmapping_1</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_DataSession3SriLankaDistrictsshp_1,
    colName: 'shapeISO',
    zoom: 10,
    collapsed: true,
    map: map
